...
# exoncnt_master is generated by concatenating all nonTSS.exoncnt.txt files and prefixing the header.
# cat *.nonTSS.exoncnt.txt | grep -v ref_ex_part > nonTSS.exoncnt.txt
exoncnt_master <- paste0(outdir,'/nonTSS.exoncnt.txt')
