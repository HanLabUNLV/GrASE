...
ggplot(specificity_tbl, aes(group=var, y=val, x=ReadDepth)) +
  ...
  ylim(0,1)+
  theme_bw()
ggsave("Spec_pvalue_lineplot_A3SS.pdf", width = 6, height = 5, dpi = 100, units = "in", device='pdf')
...
ggsave("Sens_lineplot_A3SS.pdf", width = 18, height = 7, dpi = 100, units = "in", device='pdf')
...
ggplot(sens_tbl, aes(group=var, y=val, x=ReadDepth)) +
  ...
  theme_bw() +
  facet_wrap(~FoldChange, nrow=2)
ggsave("Sens_adjpvalue_lineplot_A3SS.pdf", width = 18, height = 7, dpi = 100, units = "in", device='pdf')
...
ggplot(specificity_tbl, aes(group=var, y=val, x=ReadDepth)) +
  ...
  ylim(0,1)+
  theme_bw()
ggsave("Spec_adjpvalue_lineplot_A3SS.pdf", width = 6, height = 5, dpi = 100, units = "in", device='pdf')
