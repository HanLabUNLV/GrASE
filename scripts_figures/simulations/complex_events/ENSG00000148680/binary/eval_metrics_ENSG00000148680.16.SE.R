...
dxr1 <- read.table("/home/dwito/GrASE_package/SplicingGraphs/candidate_genes/_simulations/dexseq/ENSG00000148680.16_binary/ENSG00000148680.16_dexseq_corrected_padj.txt", header=TRUE, sep="\t")
...
jcec <- read.table("/home/dwito/GrASE_package/SplicingGraphs/candidate_genes/_simulations/rmats/ENSG00000148680.16_binary/SE.MATS.JCEC.txt", header=TRUE, sep="\t")
jcec <- jcec %>% 
  separate_wider_delim(ID, "_", names = c("FoldChange", "ReadDepth", "SimRun"))
...
jc <- read.table("/home/dwito/GrASE_package/SplicingGraphs/candidate_genes/_simulations/rmats/ENSG00000148680.16_binary/SE.MATS.JC.txt", header=TRUE, sep="\t")
jc <- jc %>% 
  separate_wider_delim(ID, "_", names = c("FoldChange", "ReadDepth", "SimRun"))
...
#total simulations
folders_50K_A3SS <- read.table("/home/dwito/GrASE_package/SplicingGraphs/candidate_genes/_simulations/ENSG00000148680.16_binary/folders_50k.txt")
