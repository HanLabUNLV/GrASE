...
jcec <- read.table("/home/dwito/GrASE_package/SplicingGraphs/candidate_genes/_simulations/rmats/ENSG00000148680.16_complex/SE.MATS.JCEC.txt", header=TRUE, sep="\t")
jcec <- jcec %>% 
  separate_wider_delim(ID, "_", names = c("FoldChange", "ReadDepth", "SimRun"))
...
jc <- read.table("/home/dwito/GrASE_package/SplicingGraphs/candidate_genes/_simulations/rmats/ENSG00000148680.16_complex/SE.MATS.JC.txt", header=TRUE, sep="\t")
jc <- jc %>% 
  separate_wider_delim(ID, "_", names = c("FoldChange", "ReadDepth", "SimRun"))
