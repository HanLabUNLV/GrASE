...
jcec <- read.table("/mnt/storage/jaquino/polyester_sim_2/SE_A3SS/A3SS_rmats_disp30/A3SS.MATS.JCEC.txt", header=TRUE, sep="\t")
jcec <- jcec %>% 
  separate_wider_delim(ID, "_", names = c("FoldChange", "ReadDepth", "SimRun"))
...
jc <- read.table("/mnt/storage/jaquino/polyester_sim_2/SE_A3SS/A3SS_rmats_disp30/A3SS.MATS.JC.txt", header=TRUE, sep="\t")
jc <- jc %>% 
  separate_wider_delim(ID, "_", names = c("FoldChange", "ReadDepth", "SimRun"))
...
##################################################################################################################
# A3SS for TRERF1 gene (ENSG00000117400.18)
dxr1 <- read.table("/mnt/storage/jaquino/polyester_sim_2/A5SS_A3SS/disp30/A3SS_dexseq_corrected_padj.txt", header=TRUE, sep="\t")
...
jcec <- read.table("/mnt/storage/jaquino/polyester_sim_2/A5SS_A3SS/disp30/A3SS.MATS.JCEC.txt", header=TRUE, sep="\t")
jcec <- jcec %>% 
  separate_wider_delim(ID, "_", names = c("FoldChange", "ReadDepth", "SimRun"))
jcec$ReadDepth <- as.numeric(gsub("RD","", jcec$ReadDepth))
jcec$FoldChange <- gsub("FCminus","-", jcec$FoldChange)
...
jc <- read.table("/mnt/storage/jaquino/polyester_sim_2/A5SS_A3SS/disp30/A3SS.MATS.JCEC.txt", header=TRUE, sep="\t")
jc <- jc %>% 
  separate_wider_delim(ID, "_", names = c("FoldChange", "ReadDepth", "SimRun"))
jc$ReadDepth <- as.numeric(gsub("RD","", jc$ReadDepth))
jc$FoldChange <- gsub("FCminus","-", jc$FoldChange)
...
#combine the two specificity tables from MPL and TRERF1 for A3SS for raw p-values
...
write.table(specificity_tbl, "/mnt/storage/jaquino/polyester_sim_2/A3SS_MPL_TRERF1_res/Spec_pvalue_A3SS_MPL_TRERF1_disp30.txt", 
...
ggsave("/mnt/storage/jaquino/polyester_sim_2/A3SS_MPL_TRERF1_res/Spec_pvalue_lineplot_A3SS_MPL_TRERF1_disp30.pdf", width = 10, height = 6, dpi = 100, units = "in", device='pdf')

#combine the two sensitivity tables from MPL and TRERF1 for A3SS for raw p-values
sens_tbl <- rbind(sens_tbl_SE_A3SS, sens_tbl_A3SS_A5SS)
sens_tbl$var2 <- paste0(sens_tbl$var, sens_tbl$gene)
write.table(sens_tbl, "/mnt/storage/jaquino/polyester_sim_2/A3SS_MPL_TRERF1_res/Sens_pvalue_A3SS_MPL_TRERF1_disp30.txt", 
            sep="\t", quote=FALSE, row.names = FALSE)
...
ggsave("/mnt/storage/jaquino/polyester_sim_2/A3SS_MPL_TRERF1_res/Sens_pvalue_lineplot_A3SS_MPL_TRERF1_disp30.pdf", width = 28, height = 12, dpi = 100, units = "in", device='pdf')

#combine the two specificity tables from MPL and TRERF1 for A3SS for adjusted p-values
specificity_tbl <- rbind(specificity_tbl_SE_A3SS_adj, specificity_tbl_A3SS_A5SS_adj)
specificity_tbl$var2 <- paste0(specificity_tbl$var, specificity_tbl$gene)
write.table(specificity_tbl, "/mnt/storage/jaquino/polyester_sim_2/A3SS_MPL_TRERF1_res/Spec_pvalue_A3SS_MPL_TRERF1_disp30_adj.txt", 
            sep="\t", quote=FALSE, row.names = FALSE)
...
ggplot(specificity_tbl, aes(group=var2, y=val, x=ReadDepth)) +
  ...
  ylim(0,1)+
  theme_bw(base_size = 20)
ggsave("/mnt/storage/jaquino/polyester_sim_2/A3SS_MPL_TRERF1_res/Spec_pvalue_lineplot_A3SS_MPL_TRERF1_adj_disp30.pdf", width = 10, height = 6, dpi = 100, units = "in", device='pdf')

#combine the two sensitivity tables from MPL and TRERF1 for A3SS for adjusted p-values
sens_tbl <- rbind(sens_tbl_SE_A3SS_adj, sens_tbl_A3SS_A5SS_adj)
sens_tbl$var2 <- paste0(sens_tbl$var, sens_tbl$gene)
write.table(sens_tbl, "/mnt/storage/jaquino/polyester_sim_2/A3SS_MPL_TRERF1_res/Sens_pvalue_A3SS_MPL_TRERF1_disp30_adj.txt", 
            sep="\t", quote=FALSE, row.names = FALSE)
...
ggplot(sens_tbl, aes(group=var2, y=val, x=ReadDepth)) +
  ...
  theme_bw(base_size = 20) +
  facet_wrap(~FoldChange, nrow=2)
ggsave("/mnt/storage/jaquino/polyester_sim_2/A3SS_MPL_TRERF1_res/Sens_pvalue_lineplot_A3SS_MPL_TRERF1_adj_disp30.pdf", width = 28, height = 12, dpi = 100, units = "in", device='pdf')
