...
library(tidyverse)
setwd("/mnt/storage/jaquino/polyester_sim_2/SE_A5SS/dexseq_disp3")

folders_50K <- read.table("/mnt/storage/jaquino/polyester_sim_2/SE_A5SS/folders_ID_50K.txt", header=FALSE, sep="\t")

#SE from the RBBP5 (ENSG00000117222.14) gene
#Successful DEXSeq simulation runs
dxr1 <- read.table("/mnt/storage/jaquino/polyester_sim_2/SE_A5SS/dexseq_disp3/dexseq_corrected_padj.txt", header=TRUE, sep="\t")
...
dxr1_exon4 <- dxr1_exon4 %>% 
  separate_wider_delim(ID, "_", names = c("FoldChange", "ReadDepth", "SimRun"))
dxr1_exon4$ReadDepth <- as.numeric(gsub("RD","", dxr1_exon4$ReadDepth))
dxr1_exon4$FoldChange <- gsub("FC","", dxr1_exon4$FoldChange)
dxr1_exon4$FoldChange <- gsub("minus","-", dxr1_exon4$FoldChange)
dxr1_exon4$FoldChange <- gsub("plus","", dxr1_exon4$FoldChange)
dxr1_exon4$FoldChange <- as.numeric(dxr1_exon4$FoldChange)

dexseq_FC_RD_freq <- data.frame(table(dxr1_exon4$FoldChange, dxr1_exon4$ReadDepth))
dexseq_FC_RD_freq$ID <- "DEXSeq"


jcec <- read.table("/mnt/storage/jaquino/polyester_sim_2/SE_A5SS/SE_rmats_disp3/SE.MATS.JCEC.txt", header=TRUE, sep="\t")
jcec <- jcec %>% 
  separate_wider_delim(ID, "_", names = c("FoldChange", "ReadDepth", "SimRun"))
...
jc <- read.table("/mnt/storage/jaquino/polyester_sim_2/SE_A5SS/SE_rmats_disp3/SE.MATS.JC.txt", header=TRUE, sep="\t")
jc <- jc %>% 
  separate_wider_delim(ID, "_", names = c("FoldChange", "ReadDepth", "SimRun"))
...
########################################################################################################################
# dexseq exon 4 (skipped exon) table
dxr1_exon4$sig.pvalue <- NA
for(i in 1:nrow(dxr1_exon4)){
  if(is.na(dxr1_exon4$pvalue[i])){
    next
  }
  if(dxr1_exon4$pvalue[i] <= 0.05){
    dxr1_exon4$sig.pvalue[i] <- "+"
  }
  if(dxr1_exon4$pvalue[i] > 0.05){
    dxr1_exon4$sig.pvalue[i] <- "-"
  }
...
dxr1_exon4$sig.adjpvalue <- NA
for(i in 1:nrow(dxr1_exon4)){
  if(is.na(dxr1_exon4$corrected.padj[i])){
    next
  }
  if(dxr1_exon4$corrected.padj[i] <= 0.05){
    dxr1_exon4$sig.adjpvalue[i] <- "+"
  }
  if(dxr1_exon4$corrected.padj[i] > 0.05){
    dxr1_exon4$sig.adjpvalue[i] <- "-"
  }
...
dexseq_jcec_merge <- merge(dxr1_exon4, jcec, by=c("FoldChange", "ReadDepth", "SimRun"))
dexseq_jc_merge <- merge(dxr1_exon4, jc, by=c("FoldChange", "ReadDepth", "SimRun"))
...
specificity_tbl_SE_A5SS <- specificity_tbl
specificity_tbl_SE_A5SS$gene <- "RBBP5"
...
sens_tbl_SE_A5SS <- sens_tbl
sens_tbl_SE_A5SS$gene <- "RBBP5"
...
sens_tbl_SE_A5SS_adj <- sens_tbl
sens_tbl_SE_A5SS_adj$gene <- "RBBP5"
...
specificity_tbl_SE_A5SS_adj <- specificity_tbl
specificity_tbl_SE_A5SS_adj$gene <- "RBBP5"
##################################################################################################################
# SE for MPL gene (ENSG00000117400.18)
dxr1 <- read.table("/mnt/storage/jaquino/polyester_sim_2/SE_A3SS/dexseq_disp3/dexseq_corrected_padj.txt", header=TRUE, sep="\t")
...
dxr1_exon14 <- dxr1 %>% 
  filter(featureID=="E014")

dxr1_exon14 <- dxr1_exon14 %>% 
  separate_wider_delim(ID, "_", names = c("FoldChange", "ReadDepth", "SimRun"))
dxr1_exon14$ReadDepth <- as.numeric(gsub("RD","", dxr1_exon14$ReadDepth))
dxr1_exon14$FoldChange <- gsub("FC","", dxr1_exon14$FoldChange)
dxr1_exon14$FoldChange <- gsub("minus","-", dxr1_exon14$FoldChange)
dxr1_exon14$FoldChange <- gsub("plus","", dxr1_exon14$FoldChange)
dxr1_exon14$FoldChange <- as.numeric(dxr1_exon14$FoldChange)

dexseq_FC_RD_freq <- data.frame(table(dxr1_exon14$FoldChange, dxr1_exon14$ReadDepth))
dexseq_FC_RD_freq$ID <- "DEXSeq"


jcec <- read.table("/mnt/storage/jaquino/polyester_sim_2/SE_A3SS/SE_rmats_disp3/SE.MATS.JCEC.txt", header=TRUE, sep="\t")
jcec <- jcec %>% 
  separate_wider_delim(ID, "_", names = c("FoldChange", "ReadDepth", "SimRun"))
jcec$ReadDepth <- as.numeric(gsub("RD","", jcec$ReadDepth))
jcec$FoldChange <- gsub("FCminus","-", jcec$FoldChange)
...
jc <- read.table("/mnt/storage/jaquino/polyester_sim_2/SE_A3SS/SE_rmats_disp3/SE.MATS.JC.txt", header=TRUE, sep="\t")
jc <- jc %>% 
  separate_wider_delim(ID, "_", names = c("FoldChange", "ReadDepth", "SimRun"))
jc$ReadDepth <- as.numeric(gsub("RD","", jc$ReadDepth))
jc$FoldChange <- gsub("FCminus","-", jc$FoldChange)
...
########################################################################################################################
# dexseq exon 14 (skipped exon) table
dxr1_exon14$sig.pvalue <- NA
for(i in 1:nrow(dxr1_exon14)){
  if(is.na(dxr1_exon14$pvalue[i])){
    next
  }
  if(dxr1_exon14$pvalue[i] <= 0.05){
    dxr1_exon14$sig.pvalue[i] <- "+"
  }
  if(dxr1_exon14$pvalue[i] > 0.05){
    dxr1_exon14$sig.pvalue[i] <- "-"
  }
...
dxr1_exon14$sig.adjpvalue <- NA
for(i in 1:nrow(dxr1_exon14)){
  if(is.na(dxr1_exon14$corrected.padj[i])){
    next
  }
  if(dxr1_exon14$corrected.padj[i] <= 0.05){
    dxr1_exon14$sig.adjpvalue[i] <- "+"
  }
  if(dxr1_exon14$corrected.padj[i] > 0.05){
    dxr1_exon14$sig.adjpvalue[i] <- "-"
  }
...
dexseq_jcec_merge <- merge(dxr1_exon14, jcec, by=c("FoldChange", "ReadDepth", "SimRun"))
dexseq_jc_merge <- merge(dxr1_exon14, jc, by=c("FoldChange", "ReadDepth", "SimRun"))
...
specificity_tbl_SE_A3SS$gene <- "MPL"
...
specificity_tbl_SE_A3SS_adj$gene <- "MPL"

#combine the two specificity tables from MPL and RBBP5 for SE for raw p-values
specificity_tbl <- rbind(specificity_tbl_SE_A3SS, specificity_tbl_SE_A5SS)
specificity_tbl$var2 <- paste0(specificity_tbl$var, specificity_tbl$gene)
write.table(specificity_tbl, "/mnt/storage/jaquino/polyester_sim_2/SE_MPL_RBBP5_res/Spec_pvalue_SE_MPL_RBBP5_disp3.txt", 
...
ggsave("/mnt/storage/jaquino/polyester_sim_2/SE_MPL_RBBP5_res/Spec_pvalue_lineplot_SE_MPL_RBBP5.pdf", width = 10, height = 6, dpi = 100, units = "in", device='pdf')

#combine the two sensitivity tables from MPL and RBBP5 for SE for raw p-values
sens_tbl <- rbind(sens_tbl_SE_A3SS, sens_tbl_SE_A5SS)
sens_tbl$var2 <- paste0(sens_tbl$var, sens_tbl$gene)
write.table(sens_tbl, "/mnt/storage/jaquino/polyester_sim_2/SE_MPL_RBBP5_res/Sens_pvalue_SE_MPL_RBBP5_disp3.txt", 
            sep="\t", quote=FALSE, row.names = FALSE)
...
ggsave("/mnt/storage/jaquino/polyester_sim_2/SE_MPL_RBBP5_res/Sens_pvalue_lineplot_SE_MPL_RBBP5.pdf", width = 28, height = 12, dpi = 100, units = "in", device='pdf')

#combine the two specificity tables from MPL and RBBP5 for SE for adjusted p-values
specificity_tbl <- rbind(specificity_tbl_SE_A3SS_adj, specificity_tbl_SE_A5SS_adj)
specificity_tbl$var2 <- paste0(specificity_tbl$var, specificity_tbl$gene)
write.table(specificity_tbl, "/mnt/storage/jaquino/polyester_sim_2/SE_MPL_RBBP5_res/Spec_pvalue_SE_MPL_RBBP5_disp3_adj.txt", 
            sep="\t", quote=FALSE, row.names = FALSE)
...
ggplot(specificity_tbl, aes(group=var2, y=val, x=ReadDepth)) +
  ...
  ylim(0,1)+
  theme_bw(base_size = 20)
ggsave("/mnt/storage/jaquino/polyester_sim_2/SE_MPL_RBBP5_res/Spec_pvalue_lineplot_SE_MPL_RBBP5_adj.pdf", width = 10, height = 6, dpi = 100, units = "in", device='pdf')

#combine the two sensitivity tables from MPL and RBBP5 for SE for adjusted p-values
sens_tbl <- rbind(sens_tbl_SE_A3SS_adj, sens_tbl_SE_A5SS_adj)
sens_tbl$var2 <- paste0(sens_tbl$var, sens_tbl$gene)
write.table(sens_tbl, "/mnt/storage/jaquino/polyester_sim_2/SE_MPL_RBBP5_res/Sens_pvalue_SE_MPL_RBBP5_disp3_adj.txt", 
            sep="\t", quote=FALSE, row.names = FALSE)
...
ggplot(sens_tbl, aes(group=var2, y=val, x=ReadDepth)) +
  ...
  theme_bw(base_size = 20) +
  facet_wrap(~FoldChange, nrow=2)
ggsave("/mnt/storage/jaquino/polyester_sim_2/SE_MPL_RBBP5_res/Sens_pvalue_lineplot_SE_MPL_RBBP5_adj.pdf", width = 28, height = 12, dpi = 100, units = "in", device='pdf')