#raw pvalue
sens_raw <- read.table("/mnt/storage/jaquino/polyester_sim_2/A3SS_MPL_TRERF1_res/Sens_pvalue_A3SS_MPL_TRERF1_disp30.txt", header=TRUE, sep="\t")
spec_raw <- read.table("/mnt/storage/jaquino/polyester_sim_2/A3SS_MPL_TRERF1_res/Spec_pvalue_A3SS_MPL_TRERF1_disp30.txt", header=TRUE, sep="\t")
...
write.table(accuracy_combine, "/mnt/storage/jaquino/polyester_sim_2/A3SS_MPL_TRERF1_res/Acc_pvalue_A3SS_MPL_TRERF1_disp30.txt", 
...
ggsave("/mnt/storage/jaquino/polyester_sim_2/A3SS_MPL_TRERF1_res/Acc_pvalue_lineplot_A3SS_MPL_TRERF1_disp30.pdf", width = 28, height = 12, dpi = 100, units = "in", device='pdf')

#adjusted p-value
sens_adj <- read.table("/mnt/storage/jaquino/polyester_sim_2/A3SS_MPL_TRERF1_res/Sens_pvalue_A3SS_MPL_TRERF1_disp30_adj.txt", header=TRUE, sep="\t")
spec_adj <- read.table("/mnt/storage/jaquino/polyester_sim_2/A3SS_MPL_TRERF1_res/Spec_pvalue_A3SS_MPL_TRERF1_disp30_adj.txt", header=TRUE, sep="\t")
...
write.table(accuracy_combine, "/mnt/storage/jaquino/polyester_sim_2/A3SS_MPL_TRERF1_res/Acc_pvalue_A3SS_MPL_TRERF1_disp30_adj.txt", 
            sep="\t", quote=FALSE, row.names = FALSE)
...
ggplot(accuracy_combine, aes(group=var2, y=val, x=factor(ReadDepth))) +
  ...
  theme_bw(base_size = 20) +
  facet_wrap(~FoldChange, nrow=2)
ggsave("/mnt/storage/jaquino/polyester_sim_2/A3SS_MPL_TRERF1_res/Acc_pvalue_lineplot_A3SS_MPL_TRERF1_adj_disp30.pdf", width = 28, height = 12, dpi = 100, units = "in", device='pdf')
