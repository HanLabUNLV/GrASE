...
dxr1 <- read.table("/mnt/storage/jaquino/polyester_sim_2/A5SS_A3SS/A5SS_dexseq_corrected_padj.txt", header=TRUE, sep="\t")
...
jcec <- read.table("/mnt/storage/jaquino/polyester_sim_2/A5SS_A3SS/A5SS.MATS.JCEC.txt", header=TRUE, sep="\t")
jcec <- jcec %>% 
  separate_wider_delim(ID, "_", names = c("FoldChange", "ReadDepth", "SimRun"))
jcec$ReadDepth <- as.numeric(gsub("RD","", jcec$ReadDepth))
jcec$FoldChange <- gsub("FCminus","-", jcec$FoldChange)
...
jc <- read.table("/mnt/storage/jaquino/polyester_sim_2/A5SS_A3SS/A5SS.MATS.JCEC.txt", header=TRUE, sep="\t")
jc <- jc %>% 
  separate_wider_delim(ID, "_", names = c("FoldChange", "ReadDepth", "SimRun"))
jc$ReadDepth <- as.numeric(gsub("RD","", jc$ReadDepth))
jc$FoldChange <- gsub("FCminus","-", jc$FoldChange)
...
write.table(specificity_tbl, "/mnt/storage/jaquino/polyester_sim_2/A5SS_RBBP5_TRERF1_res/Spec_pvalue_A5SS_RBBP5_TRERF1_disp3.txt", 
...
ggsave("/mnt/storage/jaquino/polyester_sim_2/A5SS_RBBP5_TRERF1_res/Spec_pvalue_lineplot_A5SS_RBBP5_TRERF1.pdf", width = 10, height = 6, dpi = 100, units = "in", device='pdf')
...
write.table(sens_tbl, "/mnt/storage/jaquino/polyester_sim_2/A5SS_RBBP5_TRERF1_res/Sens_pvalue_A5SS_RBBP5_TRERF1_disp3.txt", 
            sep="\t", quote=FALSE, row.names = FALSE)
...
ggsave("/mnt/storage/jaquino/polyester_sim_2/A5SS_RBBP5_TRERF1_res/Sens_pvalue_lineplot_A5SS_RBBP5_TRERF1.pdf", width = 28, height = 12, dpi = 100, units = "in", device='pdf')
...
specificity_tbl$var2 <- paste0(specificity_tbl$var, specificity_tbl$gene)
write.table(specificity_tbl, "/mnt/storage/jaquino/polyester_sim_2/A5SS_RBBP5_TRERF1_res/Spec_pvalue_A5SS_RBBP5_TRERF1_disp3_adj.txt", 
            sep="\t", quote=FALSE, row.names = FALSE)
...
ggplot(specificity_tbl, aes(group=var2, y=val, x=ReadDepth)) +
  ...
  ylim(0,1)+
  theme_bw(base_size = 20)
ggsave("/mnt/storage/jaquino/polyester_sim_2/A5SS_RBBP5_TRERF1_res/Spec_pvalue_lineplot_A5SS_RBBP5_TRERF1_adj.pdf", width = 10, height = 6, dpi = 100, units = "in", device='pdf')
...
sens_tbl$var2 <- paste0(sens_tbl$var, sens_tbl$gene)
write.table(sens_tbl, "/mnt/storage/jaquino/polyester_sim_2/A5SS_RBBP5_TRERF1_res/Sens_pvalue_A5SS_RBBP5_TRERF1_disp3_adj.txt", 
            sep="\t", quote=FALSE, row.names = FALSE)
...
ggplot(sens_tbl, aes(group=var2, y=val, x=ReadDepth)) +
  ...
  theme_bw(base_size = 20) +
  facet_wrap(~FoldChange, nrow=2)
ggsave("/mnt/storage/jaquino/polyester_sim_2/A5SS_RBBP5_TRERF1_res/Sens_pvalue_lineplot_A5SS_RBBP5_TRERF1_adj.pdf", width = 28, height = 12, dpi = 100, units = "in", device='pdf')
